...
class DashboardTabelLaporanScreen extends StatefulWidget {
  ...
  const DashboardTabelLaporanScreen({
    super.key,
  ...
  @override
  State<DashboardTabelLaporanScreen> createState() =>
      _DashboardTabelLaporanScreenState();
}

class _DashboardTabelLaporanScreenState
    extends State<DashboardTabelLaporanScreen> {
  ...
  @override
  void didUpdateWidget(covariant DashboardTabelLaporanScreen oldWidget) {
